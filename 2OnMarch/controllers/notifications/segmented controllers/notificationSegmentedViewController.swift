//
//  notificationSegmentedViewController.swift
//  2OnMarch
//
...
class notificationSegmentedViewController: UIViewController, IndicatorInfoProvider {

    @IBOutlet weak var classTableView: UITableView!
    var request = [NotificationDataModel]()
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        NotificationFunctionModel.getData { (result) in
            self.request = result
...
extension notificationSegmentedViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row % 2 == 0 {
            ...
            cell.configCell(model: self.request[num])
